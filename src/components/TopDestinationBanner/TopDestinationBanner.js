		...
		<div >
			...
			<Grid container spacing={2} direction="row" className={classes.bg}>
					<Grid item xs={3} className={classes.gitem}>
						<img src={logo1} alt="bhutan-img" className={classes.imageStyle}></img>
						<p>Bhutan Tour Itinerary</p>
					</Grid>
					<Grid item xs={3} className={classes.gitem}>
						<img src={logo2} alt="Brahmaputra-img" className={classes.imageStyle}></img>
						<p>Brahmaputra Explorer</p>
					</Grid>
					<Grid item xs={3} className={classes.gitem}>
						<img src={logo3} alt="Myanmar-img" className={classes.imageStyle}></img>
